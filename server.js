...
var multiIntentClassifier = new classifier_1.default(classifier_1.intentPatterns);
//const naiveBayesClassifier = new NaiveBayesClassifier();
// Endpoint for classifying input text
app.post('/classify', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var query;
